      ...
      <div className="registerform ">
        ...
        <form onSubmit={handlesubmit} className="card p-3">
          ...
          <button
            ...
            className="mt-2 user-btn btn btn-warning"
          >
            Login as Guest
          </button>
          <button
            ...
            className="mt-2 admin-btn btn btn-primary"
          >
            Login as Admin
          </button>
        ...
        <h7 className="text-center mt-3 login-notice">Please wait for few seconds to get logged in,since this website was hoisted in free service</h7>
      </div>
    </Layout>
  );
};
